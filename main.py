# bot_zonas.py - Optimizado para Railway
...
# Constants - Usar variable de entorno para el TOKEN
TOKEN = os.environ.get("TELEGRAM_TOKEN", "8150577858:AAFp74F_ubS1nwAz39U2CLDBplnsXxb2yK8")
...
def format_list():
    ...
    for i, item in enumerate(waiting_list, 1):
        ...
        if i % 2 == 0 and i < len(waiting_list):  # Si es el tercero y no es el último
